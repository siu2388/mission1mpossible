    ...
    <c:set
      ...
      <div class="row row-cols-5 g-4">
         ...
         >
            <div class="col col77">
              <c:choose>
                <c:when test="${mission.success eq '성공'}">
                  <div
                  class="card card77 bg-success bg-opacity-75"
                  href="missions"
                  role="button"
                  />
                </c:when>
                <c:when test="${mission.success eq '실패'}">
                  <div
                  class="card card77 bg-danger bg-opacity-75"
                  href="missions"
                  role="button"
                  />
                </c:when>
                <c:when test="${mission.success eq null && mission.createdAt eq today}">
                  <div
                  class="card card77 bg-secondary-subtle"
                  href="missions"
                  role="button"
                  />
                </c:when>
